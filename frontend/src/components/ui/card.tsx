...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "flex flex-col gap-4 rounded-xl border border-border bg-card py-4 text-sm text-card-foreground shadow-sm",
        className
      )}
      {...props}
    />
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-base leading-snug font-semibold text-[var(--ink-900)] group-data-[size=sm]/card:text-sm",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-[1.5rem] border-t border-[var(--line-subtle)] bg-[var(--surface-subtle)] p-5 group-data-[size=sm]/card:p-4",
        className
      )}
      {...props}
    />
